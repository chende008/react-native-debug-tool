...
export default class FloatPanelController extends PureComponent {
    ...
    renderPageFirst = (currentUrl) => {
        return <View style={{flex: 1, width: screenWidth, backgroundColor: DebugColors.white}}>
            ...
            {!isEmpty(currentUrl) && <DebugItem title='环境切换' text={currentUrl} style={{color: DebugColors.red, fontSize: 13}} onPress={() => this.changeToDetail(1, 'EnvironmentChange', '服务器环境切换')} showLine/>}
